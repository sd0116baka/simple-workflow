...
} from "../src/workflow/execution-intent-contract.js";
...
test("builds execution intent append request with the same contract shape", () => {
  const appendRequest = buildExecutionIntentRequest({
    packageId: "task-context-package:tasks/task-003.yaml",
    confidence: "medium",
    selectionReasoning: ["当前任务可执行"],
    candidateComparison: [
      {
        packageId: "task-context-package:tasks/task-003.yaml",
        decision: "selected",
