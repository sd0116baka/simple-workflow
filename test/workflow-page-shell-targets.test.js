...
function createElements() {
  return Object.fromEntries([
    ...
    "stageSwitchExecutionAdmission",
    "stageSwitchIsolatedWorkspace",
    "stageSwitchMainAgent",
    "stageSwitchExecutionAgent",
    "stageSwitchReviewAgent",
    "stageSwitchConvergence",
    "restartButton",
    "refreshButton",
...
test("workflow page shell targets expose the command target group", () => {
  ...
  assert.deepEqual(createWorkflowPageCommandTargets(elements), {
    ...
    runWorkflowButton: elements.runWorkflowButton,
    cancelRecommendationButton: elements.cancelRecommendationButton,
    stageSwitchExecutionAdmission: elements.stageSwitchExecutionAdmission,
    stageSwitchIsolatedWorkspace: elements.stageSwitchIsolatedWorkspace,
    stageSwitchMainAgent: elements.stageSwitchMainAgent,
    stageSwitchExecutionAgent: elements.stageSwitchExecutionAgent,
    stageSwitchReviewAgent: elements.stageSwitchReviewAgent,
    stageSwitchConvergence: elements.stageSwitchConvergence,
    recommendationStatus: elements.recommendationStatus,
    recommendationResult: elements.recommendationResult,
    humanDecisionStatus: elements.humanDecisionStatus,
